...
<body>
	...
	<div class="html-container">
		...
		<div class="nav">
			...
			<ul>
				<li class="nav-item"><a href="javascript:;"><i
						class="my-icon nav-icon icon_1"></i><span id="userid"><%=loginUser.getuser_id()%></span><span
						id="username"><%=loginUser.getuser_name()%></span><i
						class="my-icon nav-more"></i></a><a href="logout">退出登录</a></li>
				<li class="nav-item"><a href="javascript:;"><i
					...
					<ul>
						...
						<li><a class="menu-item" href="javascript:;" data-href="test"><span>分类管理</span></a></li>
					</ul></li>
				<li class="nav-item"><a href="javascript:;"><i
					...
					<ul>
						<li><a class="menu-item" href="javascript:;"
							data-href="foodlistpage"><span>食品列表</span></a></li>
						<li><a class="menu-item" href="javascript:;"
							data-href="food/addfoodtypepage"><span>添加食品类型</span></a></li>
						<li><a class="menu-item" href="javascript:;"
							data-href="food/addfoodpage"><span>添加食品信息</span></a></li>
						<li><a class="menu-item" href="javascript:;"
							data-href="food/deletefoodpage"><span>删除食品</span></a></li>
					</ul></li>
				<li class="nav-item"><a href="javascript:;"><i
		...
		<div class="right-iframe" id="right-iframe">
			<iframe id="content" src='welcome.html' width="1000px" height="100%"
